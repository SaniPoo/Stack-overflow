...
import  upvotes from'./upvotes.png'
import downvotes from './downvotes.png'
                            ...
                            <section className="post-ans-container">
                                ...
                                <form onSubmit= {(e) => { handlePostAns( e, question.answer.length) }}>
                                    <label htmlFor="answer">
                                        <textarea name="name" id = "answer" cols= "30" rows="10" onChange={e => setAnswer(e.target.value)}></textarea><br />
